...
export default function Home() {
  const features = [
    ...
    },
    {
      ...
      description: 'Get intelligent suggestions on how to optimize your code for better performance.'
    },
    {
      icon: '📄',
      title: 'PDF Reports',
  ...
  const steps = [
    ...
    { step: '03', title: 'Get Results', description: 'View detailed report with rating, issues and AI suggestions' },
  ];
      ...
      <section style={{
        ...
        <div className="container">
          ...
          <p style={{
            ...
            Get instant Big-O analysis, performance rating, and AI-powered optimization suggestions.
          </p>
